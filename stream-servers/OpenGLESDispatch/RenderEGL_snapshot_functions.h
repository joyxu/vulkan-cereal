// Auto-generated with: android/scripts/gen-entries.py --mode=functions stream-servers/OpenGLESDispatch/render_egl_snapshot.entries --output=stream-servers/OpenGLESDispatch/RenderEGL_snapshot_functions.h
