// Auto-generated with: android/scripts/gen-entries.py --mode=funcargs stream-servers/gl/OpenGLESDispatch/gles3_only.entries --output=gldispatch/include/OpenGLESDispatch/gles3_only_functions.h
