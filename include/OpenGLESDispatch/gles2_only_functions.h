// Auto-generated with: android/scripts/gen-entries.py --mode=funcargs stream-servers/gl/OpenGLESDispatch/gles2_only.entries --output=gldispatch/include/OpenGLESDispatch/gles2_only_functions.h
