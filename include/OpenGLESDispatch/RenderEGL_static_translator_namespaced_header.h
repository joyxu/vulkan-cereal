// Auto-generated with: android/scripts/gen-entries.py --mode=static_translator_namespaced_header stream-servers/gl/OpenGLESDispatch/render_egl.entries --output=gldispatch/include/OpenGLESDispatch/RenderEGL_static_translator_namespaced_header.h
