// Auto-generated with: android/scripts/gen-entries.py --mode=functions stream-servers/gl/OpenGLESDispatch/render_egl_extensions.entries --output=gldispatch/include/OpenGLESDispatch/RenderEGL_extensions_functions.h
