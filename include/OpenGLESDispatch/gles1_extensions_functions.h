// Auto-generated with: android/scripts/gen-entries.py --mode=funcargs stream-servers/gl/OpenGLESDispatch/gles1_extensions.entries --output=gldispatch/include/OpenGLESDispatch/gles1_extensions_functions.h
