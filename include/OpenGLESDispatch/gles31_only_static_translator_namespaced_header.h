// Auto-generated with: android/scripts/gen-entries.py --mode=static_translator_namespaced_header stream-servers/gl/OpenGLESDispatch/gles31_only.entries --output=gldispatch/include/OpenGLESDispatch/gles31_only_static_translator_namespaced_header.h
