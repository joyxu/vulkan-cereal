// Auto-generated with: android/scripts/gen-entries.py --mode=functions stream-servers/gl/OpenGLESDispatch/render_egl.entries --output=gldispatch/include/OpenGLESDispatch/RenderEGL_functions.h
