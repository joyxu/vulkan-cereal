...
./build/gfxstream-generic-apigen -i ./protocols/gles1 -D ./stream-servers/gl/gles1_dec gles1
...
./build/gfxstream-generic-apigen -i ./protocols/gles2 -D ./stream-servers/gl/gles2_dec gles2
